            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    auth.put("PhoneNumber",empty);
                    {
                        ...
                        fb.collection("NVP_Auth").document(useid).set(user).addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void aVoid) {
                                ...
                                Intent i=new Intent(Codeverification.this,HomePage_Loader.class);

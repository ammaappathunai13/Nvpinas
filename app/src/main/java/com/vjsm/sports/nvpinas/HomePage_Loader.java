...
public class HomePage_Loader extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_page__loader);
        ...
        sharedPreferences = getApplicationContext().getSharedPreferences("com.vjsm.sports.nvpinas", Context.MODE_PRIVATE);
        ...
        Fragment fragment=new Home_Bottom_Fragment();
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(HomePage_Loader.this);
        builder.setTitle("NVP`nS");

        builder.setIcon(R.drawable.nvp);

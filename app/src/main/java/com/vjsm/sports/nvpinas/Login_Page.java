...
public class Login_Page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences=getSharedPreferences("com.vjsm.sports.nvpinas",Context.MODE_PRIVATE);
        ...
        if((!sharedPreferences.getString(getString(R.string.UserId),"").equals("")))
        {
            if(!(sharedPreferences.getString(getString(R.string.Password),"")).equals("")){
                Intent s=new Intent(Login_Page.this,HomePage_Loader.class);
            ...
            Login.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (TextUtils.isEmpty(usernames)){
                        ...
                        progressDialog.show();
                        final DocumentReference drf = fb.collection("NVP_Auth").document(usernames);
                        final CollectionReference clf = fb.collection("NVP_Auth");
                                                ...
                                                if (task.isSuccessful()) {
                                                    ...
                                                    if (document.exists()) {
                                                        if (document.getString("Password").equals(passwords)){
                                                            ...
                                                            editor.commit();
                                                            isExisting=true;
                                                            Intent i=new Intent(Login_Page.this,HomePage_Loader.class);
